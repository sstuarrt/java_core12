...
public class Main2 {
    public static void main(String[] args) {
        ...
        ArrayList<Month> mas=new ArrayList<>();

        mas.add(Month.JANUARY);
        mas.add(Month.FEBRUARY);
        mas.add(Month.MARCH);
        mas.add(Month.APRIL);
        mas.add(Month.MAY);
        mas.add(Month.JUNE);
        mas.add(Month.JULY);
        mas.add(Month.AUGUST);
        mas.add(Month.SEPTEMBER);
        mas.add(Month.OCTOBER);
        mas.add(Month.NOVEMBER);
        mas.add(Month.DECEMBER);
